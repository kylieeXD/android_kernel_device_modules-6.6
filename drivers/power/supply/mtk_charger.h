...
/* Smart charger */
#define SMART_CHG_OUTDOOR_CHARGE_INC		400000
...
#define DFX_BATT_AUTH_CHECK_CNT 1
...
static const char *const xm_chg_dfx_report_text[] = {
	...
	"AntiFail","VoltageDifferenceOver","DualBattAuthFail"
};
...
#define BATTERY_CYCLE_1_TO_80 1
#define BATTERY_CYCLE_80_TO_100 80
#define BATTERY_CYCLE_100_TO_180 100
#define BATTERY_CYCLE_180_TO_300 180
/* sw jeita */
...
struct mtk_charger {
	...
	struct step_jeita_cfg0 step_normal_chg_cfg[STEP_JEITA_TUPLE_COUNT];
	bool step_normal_chg;
	...
	bool support_disable_otg_incold;
	...
	bool revcable_swap_trigger;
	bool revcable_swap_triggered;
	int swap_count;
	int rev_cable_check;
	bool rev_cable_checked;
	bool rev_cable_boostable;
	int last_rqc_status;
	int rev_cable_boosted;
	...
	int dfx_soc_not_full_cnt;
	int dfx_batt_auth_check_cnt;
	...
	bool dual_vbat_diff_flag;
	bool bypass_auth_m;
#endif
	int step_jeita_tuple_count;
	int jeita_temp_normal;
	int jeita_temp_hot;
};
...
enum usb_property {
	...
	USB_PROP_TYPEC_REVCHG_BCL,
	USB_PROP_TYPEC_RQC_CONDITION_CHECK,
	USB_PROP_TYPEC_CC_TOGGLE_18W,
	USB_PROP_TYPEC_PD_STATE_SVID,
	USB_PROP_TYPEC_PD_PID_BCD,
	USB_PROP_TYPEC_REV_CABLE_CHECK,
	USB_PROP_TYPEC_SWAP_COUNT,
	USB_PROP_TYPEC_REVCBL_SWAP_STAT,
};
...
#define XM_VID              0x2717   /* Xiaomi SVID */
#define XM_REV_CABLE_PID     0x3636   /* Xiaomi reverse cable PID */
#define XM_REV_CABLE_BCDID_A 0x0001   /* Cable port A */
#define XM_REV_CABLE_BCDID_B 0x0002   /* Cable port B */
#define PD_ROLE_VCONN_OFF      0
#define PD_ROLE_VCONN_ON       1

/* PD info structure */
struct rev_cable_info {
	u16 partner_vid;    /* partner SVID */
	u16 cable_vid;      /* cable SVID */
	u16 cable_pid;       /* cable PID */
	u16 cable_bcdid;     /* cable BcdID */
	bool is_sink;        /* current port power role */
	bool is_a_port;      /* true if A port */
	bool partner_is_xm;  /* true if partner is Xiaomi */
	bool cable_is_rev;   /* true if reverse cable */
};
